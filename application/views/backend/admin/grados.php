                  ...
                  <div class="friend-item-content">
                      <div class="more">
                        ...
                        <ul class="more-dropdown">
                          ...
                          <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_send_marks/<?php echo $class['class_id'];?>');"><?php echo get_phrase('send_marks_by_email');?></a></li>
