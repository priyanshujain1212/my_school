                            ...
                            ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a href="<?php echo base_url();?>admin/delete_question_from_online_exam/<?php echo $added_question['question_bank_id'];?>" onclick="return confirm('<?php echo get_phrase('confirm_delete');?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" title="<?php echo get_phrase('delete'); ?>"><i class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
