			...
			<table class="table table-lightbor table-lightfont">
			  ...
			  <?php if($row['password'] != ''):?> 
			    <tr>
				    ...
				    <td><?php echo get_phrase('enter_exam_password');?>: 
				    	<input type="text" name="password" placeholder="<?php echo get_phrase('enter_exam_password');?>" class="form-control" required=""></td>
			    </tr>
			   <?php endif;?>
			  <tr>
