                            ...
                            ?>
                              <div class="col-sm-12">
                                <label class="containers" style="height: 200px;">
                                  <img class="example-image" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_question_image/<?php echo $options[$i];?>');" src="<?php echo base_url();?>uploads/online_exam/<?php echo $options[$i];?>"  style="width: 150px;">
